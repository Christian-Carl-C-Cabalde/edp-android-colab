...
fun ProfileScreen(user: User, onLogout: () -> Unit) {
    Column(
        ...
        // TODO 12a: the green success card
        Card(
        ...
        // BONUS TODO 14d: an "Age" row, only when the birthdate can be read
...
fun ageFrom(birthdate: String): Int? {
    ...
    // TODO 14b: read today's year, month and day
    ...
    // TODO 14c: subtract one year if the birthday has not happened yet
    var age = ty - y
