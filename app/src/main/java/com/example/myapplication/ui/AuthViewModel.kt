...
class AuthViewModel(
    ...
    fun login(email: String, password: String) {
        // TODO 8a: check the input first
        if (email.isBlank() || password.isBlank()) {
            uiState = AuthUiState.Error("Please enter your email and password.")
            return
        }

        // TODO 8b: show the spinner
        uiState = AuthUiState.Loading

        // TODO 8c: ask the repository off the main thread
    ...
    fun register(fullName: String, email: String, password: String, birthdate: String) {
        // TODO 9a: any of the four fields is blank
